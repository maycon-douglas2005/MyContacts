...
function criarFormAddContato() {
  ...
  form.setAttribute("action", "../../Controllers/ContatoController.php");
  ...
  const conteudoP = document.createTextNode(
    "Insira os dados do contato que deseja adicionar:",
  );
  ...
  btnCloseModal.classList.add("btn-close", "ms-5");
  btnCloseModal.type = "button";
  btnCloseModal.setAttribute("data-bs-dismiss", "modal");
  btnCloseModal.addEventListener("click", () => divModal.remove());
  ...
  inputNome.classList.add("mb-1", "form-control");
  inputNome.placeholder = "Nome";
  inputNome.type = "name";
  inputNome.name = "nome";

  const inputEmail = document.createElement("input");
  inputEmail.classList.add("mb-1", "form-control");
