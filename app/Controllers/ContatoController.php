    ...
    public static function index()
    {
        ...
        foreach ($ListaContatos as $linhaListaContatos) { ?>
            <tr class="justify-content-between d-flex ">
                <td class="d-flex justify-content-center  border-bottom: 1px solid #e0e0e0"><input data-original="<?php echo $linhaListaContatos['nome'] ?>" data-id="<?php echo $linhaListaContatos['id'] ?>" type="text" readonly class="form-control-plaintext  text-center campo_nome " value="<?php echo $linhaListaContatos['nome'] ?>"></td>
                <td class="d-flex justify-content-center  border-bottom: 1px solid #e0e0e0"><input data-original="<?php echo $linhaListaContatos['email'] ?>" data-id="<?php echo $linhaListaContatos['id'] ?>" type="text" readonly class="form-control-plaintext  text-start campo_email" value="<?php echo $linhaListaContatos['email'] ?>"></td>
                <td class="d-flex justify-content-center  border-bottom: 1px solid #e0e0e0"><input data-original="<?php echo $linhaListaContatos['celular'] ?>" data-id="<?php echo $linhaListaContatos['id'] ?>" type="text" readonly class="form-control-plaintext  text-center campo_celular" value="<?php echo $linhaListaContatos['celular'] ?>"></td>
